...
local Themes = {
    ...
    ["Starry Night"] = {
        ...
        SelectedTabFrame = Color3.fromRGB(53, 0, 84),
        ItemFrame = Color3.fromRGB(32, 0, 49),
        HoverItemFrame = Color3.fromRGB(43, 0, 67),
        DropdownIcon = Color3.fromRGB(175, 0, 175),
        SectionUIStroke = Color3.fromRGB(35, 0, 54),
        MainUIStroke = Color3.fromRGB(54, 0, 85),
        Main = Color3.fromRGB(19, 0, 29),
        InputPlaceHolder = Color3.fromRGB(57, 0, 89),
        Shadow = Color3.fromRGB(19, 0, 29),
        SliderOuter = Color3.fromRGB(48, 0, 75),
        SliderInner = Color3.fromRGB(255, 0, 105),
        TabUIStroke = Color3.fromRGB(45, 0, 71),
        ToggleOuter = Color3.fromRGB(48, 0, 75),
        ToggleOuterEnabled = Color3.fromRGB(58, 0, 91),
        ToggleOuterUIStroke = Color3.fromRGB(42, 0, 65),
        ToggleOuterUIStrokeEnabled = Color3.fromRGB(255, 0, 105),
        ToggleInner = Color3.fromRGB(77, 0, 121),
        ToggleInnerEnabled = Color3.fromRGB(255, 0, 105),
        ContainerHolder = Color3.fromRGB(25, 0, 43),
        HighlightUIStroke = Color3.fromRGB(79, 0, 124),
