...
local Themes = {
    ...
    ["Bermuda.xyz"] = {
        ...
        DropdownIcon = Color3.fromRGB(48, 48, 48),
        SectionUIStroke = Color3.fromRGB(35, 41, 54),
        MainUIStroke = Color3.fromRGB(54, 65, 85),
        Main = Color3.fromRGB(19, 22, 29),
        InputPlaceHolder = Color3.fromRGB(50, 58, 79),
        Shadow = Color3.fromRGB(15, 17, 23),
        SliderOuter = Color3.fromRGB(40, 47, 64),
        SliderInner = Color3.fromRGB(111, 105, 255),
        TabUIStroke = Color3.fromRGB(40, 48, 64),
        ToggleOuter = Color3.fromRGB(39, 46, 61),
        ToggleOuterEnabled = Color3.fromRGB(61, 59, 92),
